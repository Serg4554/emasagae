...
public class ControlBean implements Serializable {
	...
	public void doGeocoding()
	{
		...
		URL urlPeticionRest = null; //Url de peticiÛn y generaciÛn de la string que la originar·
	...
	public String doGuardarAviso() {
		...
		if (numero != null && !numero.isEmpty()) {
			try {
				...
				error = "El n√∫mero debe ser num√©rico";
				return "crearAviso";
			}
		} else {
			error = "Debe especificar un n√∫mero";
			return "editarAviso";
		}
		...
		if (codigoPostal != null && !codigoPostal.isEmpty()) {
			try {
				...
				error = "El c√≥digo postal debe ser num√©rico";
				return "editarAviso";
			}
		} else {
			error = "Debe especificar un c√≥digo postal";
			return "editarAviso";
		}
		...
		if (error.equals(""))
		{//si ha llegado hasta aquÌ sin errores se aÒade la geolocalizacion
			doGeocoding();
	...
	public String doGuardarOperacion() {
		...
		if (descripcion != null && !descripcion.isEmpty()) {
			...
			error = "Debe especificar una descripciÛn";
			return "editarOperacion";
		}
